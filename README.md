...
```java
PrintWriterOf<File> pw = IoStream.file("myfile.txt").printWriter("UTF-16");
pw.write("hello");
pw.close();
File myfile = pw.getResource();        
```  
...
Sadly I do no have gradle at the ready, but I'm sure you smart foxes will know where to insert what I believe to be `ca.rbon:iostream:0.6.1`.
